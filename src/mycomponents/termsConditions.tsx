...
const TermsAndConditionsDialog = ({ children }: any) => {
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        {children}
      </AlertDialogTrigger>
      <AlertDialogContent className="max-w-4xl overflow-hidden p-6">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-2xl font-bold">Terms and Conditions</AlertDialogTitle>
          <AlertDialogDescription className="max-h-[70vh] overflow-y-auto space-y-4">
            {/* Introduction */}
