    ...
    >
      <ul
        ...
        {items.map((item, idx) => (
          <li
            key={idx}
            className="w-[200px] max-w-full relative rounded-xl border border-white border-opacity-15 px-4 py-3 flex-shrink-0 backdrop-blur-3xl bg-white bg-opacity-10  transition-colors duration-200"
          >
